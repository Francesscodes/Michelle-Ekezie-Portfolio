...
function changeItem() {
    const imgSrc = portfolioItems[itemIndex].querySelector('.work-content img').getAttribute("src");
...
/* Contact Form Submission (Optional - requires backend or service like Formspree) */
const contactForm = document.querySelector('.contact-form');

if(contactForm) {
    contactForm.addEventListener('submit', function(e) {
        // If you're not using a form service, you can add custom handling here
        // For now, the form will submit normally to the action URL
